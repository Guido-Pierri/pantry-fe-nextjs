...
import {z} from "zod";
import NextAuthProviders from "@/app/ui/nextauthproviders";
...
const SignInForm = (props: Props) => {
    ...
    return (
        ...
        >
            <div
                className="bg-gradient-to-b from-white to-slate-200 dark:from-slate-700 dark:to-slate-900 p-2 text-center">
                Sign In Form
            </div>
